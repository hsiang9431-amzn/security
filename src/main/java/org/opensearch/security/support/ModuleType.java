...
public enum ModuleType implements Serializable {
	...
	REST_MANAGEMENT_API("REST Management API", "OpenDistroSecurityRestApiActions", Boolean.TRUE),
	DLSFLS("Document- and Field-Level Security", "OpenDistroSecurityFlsDlsIndexSearcherWrapper", Boolean.TRUE),
	AUDITLOG("Audit Logging", "AuditLogImpl", Boolean.TRUE),
	MULTITENANCY("Kibana Multitenancy", "PrivilegesInterceptorImpl", Boolean.TRUE),
	...
	// COMPLIANCE("Compliance", "ComplianceIndexingOperationListenerImpl", Boolean.TRUE),
