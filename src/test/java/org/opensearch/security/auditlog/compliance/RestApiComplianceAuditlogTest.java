...
public class RestApiComplianceAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    public void testRestApiRolesEnabled() throws Exception {
        ...
        HttpResponse response = rh.executePutRequest("_opendistro/_security/api/internalusers/compuser?pretty", body, AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
        Thread.sleep(1500);
