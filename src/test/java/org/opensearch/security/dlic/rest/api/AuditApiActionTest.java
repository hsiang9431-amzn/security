...
public class AuditApiActionTest extends AbstractRestApiUnitTest {
    ...
    final Header adminCredsHeader = AbstractSecurityUnitTest.encodeBasicHeader("sarek", "sarek");
    // non-admin
    final Header nonAdminCredsHeader = AbstractSecurityUnitTest.encodeBasicHeader("random", "random");
