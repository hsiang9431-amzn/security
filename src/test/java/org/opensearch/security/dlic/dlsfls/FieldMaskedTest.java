...
public class FieldMaskedTest extends AbstractDlsFlsTest {
    ...
    public void testMaskedAggregations() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executePostRequest("/deals/_search?pretty&size=0", query, AbstractSecurityUnitTest.encodeBasicHeader("user_masked", "password"))).getStatusCode());
    ...
    public void testMaskedAggregationsRace() throws Exception {
        ...
        HttpResponse res;
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executePostRequest("/deals/_search?pretty&size=0", query, AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"))).getStatusCode());
        Assert.assertTrue(res.getBody().contains("100.100"));
    ...
    public void testMaskedSearch() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/_search?pretty&size=100", AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"))).getStatusCode());
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/_search?pretty&size=100", AbstractSecurityUnitTest.encodeBasicHeader("user_masked", "password"))).getStatusCode());
        Assert.assertTrue(res.getBody().contains("\"value\" : 32,\n      \"relation"));
        Assert.assertTrue(res.getBody().contains("\"failed\" : 0"));
        Assert.assertTrue(res.getBody().contains("cust1"));
        Assert.assertTrue(res.getBody().contains("cust2"));
    ...
    public void testMaskedGet() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/deals/0?pretty", AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"))).getStatusCode());
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/deals/0?pretty", AbstractSecurityUnitTest.encodeBasicHeader("user_masked", "password"))).getStatusCode());
        Assert.assertTrue(res.getBody().contains("\"found\" : true"));
        Assert.assertTrue(res.getBody().contains("cust1"));
        Assert.assertFalse(res.getBody().contains("cust2"));
        Assert.assertFalse(res.getBody().contains("100.100.1.1"));
