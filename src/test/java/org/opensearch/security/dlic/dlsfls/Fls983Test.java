...
public class Fls983Test extends AbstractDlsFlsTest{
    ...
    public void test() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executePostRequest("/.kibana/config/0/_update?pretty", doc, AbstractSecurityUnitTest.encodeBasicHeader("human_resources_trainee", "password"))).getStatusCode());
